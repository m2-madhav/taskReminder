...
function App() {
  ...
  const fetchTasks = async () => {
    const res = await fetch(
      "https://my-json-server.typicode.com/m2-madhav/taskReminder/tasks"
    );
  ...
  const fetchTask = async (id) => {
    const res = await fetch(
      `https://my-json-server.typicode.com/m2-madhav/taskReminder/tasks?id=${id}`
    );
    const data = res.json();
    return data;
  };
  ...
  const deleteTask = async (id) => {
    await fetch(
      `https://my-json-server.typicode.com/m2-madhav/taskReminder/tasks/{id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
